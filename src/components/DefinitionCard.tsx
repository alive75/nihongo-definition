...
const FuriganaText: React.FC<{ content: WordWithReading[]; onWordClick: (word: string) => void }> = ({ content, onWordClick }) => {
    return (
        <p className="text-lg sm:text-xl leading-loose text-slate-300">
    ...
    return (
        <div className="bg-slate-800 rounded-xl shadow-lg p-4 md:p-6 border border-slate-700 animate-fade-in relative">
            ...
            <div className="flex items-center pr-10">
                ...
                <h1 className={`font-bold text-slate-100 transition-all duration-300 ${isCollapsed && isCollapsible ? 'text-2xl sm:text-3xl' : 'text-3xl sm:text-4xl lg:text-5xl'}`}>
                    {definition.word}
                </h1>
            </div>
