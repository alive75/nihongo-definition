...
const App: React.FC = () => {
    ...
    return (
        <div className="relative flex h-screen bg-slate-900 font-sans overflow-hidden">
            <HistorySidebar
            ...
            <main className="flex-1 flex flex-col overflow-y-auto">
                <header className="sticky top-0 z-10 p-4 md:p-6 bg-slate-900/80 backdrop-blur-sm border-b border-slate-700 flex items-center gap-4">
                    <button
                        onClick={() => setIsSidebarOpen(true)}
                        className="p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded-md md:hidden"
